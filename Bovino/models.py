...
class Bovino(models.Model):
    ...
    id_padre = models.OneToOneField('self', related_name='id_padre_bovino', default=None, blank=True, null=True,verbose_name="Identificación del bovino padre")
    id_madre = models.OneToOneField('self', related_name='id_madre_bovino', default=None, blank=True, null=True,verbose_name="Identificación del bovino madre")
    id_granja = models.OneToOneField(Granja,default=None,verbose_name="Granja a la que pertenece")
    id_parto = models.OneToOneField(TipoParto,default=None,verbose_name="Tipo parto")
